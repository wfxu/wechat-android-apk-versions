...
## WeChat 6.3.32 version information
...
| Position in history | #108 of 133 archived versions |
| Days since previous release | 24 |

## Nearby versions

- Newer: [Download WeChat 6.5.3 APK](../6.5.3/) (2016-12-30)
- Older: [Download WeChat 6.3.31 APK](../6.3.31/) (2016-11-21)

## About WeChat 6.3.32

WeChat 6.3.32 is the Android client Tencent released on 2016-12-15. It is #108 of the 133 versions archived here.
It arrived 24 days after WeChat 6.3.31 (2016-11-21).
...
## How to install WeChat 6.3.32 APK

1. Download `weixin6332android960.apk` from the table above.
...
4. Uninstalling clears local chat history. Back it up inside WeChat before downgrading to 6.3.32.

## FAQ

**When was WeChat 6.3.32 released?** 2016-12-15.

**Is this WeChat 6.3.32 APK official?** Yes. Every link above resolves to Tencent's own CDN and the APK is unmodified.

**Can I downgrade from a newer WeChat to 6.3.32?** Yes, but you must uninstall the current version first, and any local chat history that was not backed up will be lost.

---

[← 返回全部 133 个版本 / All 133 WeChat Android versions](../)　|　[在线浏览 / View online](https://wfxu.github.io/wechat-android-apk-versions/6.3.32/)
