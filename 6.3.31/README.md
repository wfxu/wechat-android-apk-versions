...
| 官方下载数 | 1 |
| 版本序号 | 133 个历史版本中的第 109 新 |
| 距上一版本 | 12 天 |

## 相邻版本

- 更新版本：[微信 6.3.32 安卓版下载](../6.3.32/)（2016-12-15）
- 更早版本：[微信 6.3.30 安卓版下载](../6.3.30/)（2016-11-09）

## 关于微信 6.3.31

微信 6.3.31 是腾讯于 2016-11-21 推出的 Android 客户端版本，在本仓库收录的 133 个历史版本中排在第 109 位。
它与前一版本微信 6.3.30（2016-11-09）相隔 12 天。
需要该版本的用户通常是为了适配旧机型、回退新版改动，或用于兼容性测试。各版本的功能更新说明请以 [微信官方更新日志](https://weixin.qq.com/updates) 为准。

## 安装说明

1. 点击上表中的链接下载 `weixin6331android940.apk`。
2. 在系统设置中允许「安装未知来源应用」。
3. 若设备已安装更高版本的微信，需先卸载再安装微信 6.3.31；Android 不允许降级覆盖安装。
4. 卸载会清除本地聊天记录，降级前请先在微信内完成聊天记录备份。

## 常见问题

**微信 6.3.31 是什么时候发布的？** 2016-11-21。

**微信 6.3.31 的安装包能直接从官网下载吗？** 可以，上表的地址即为腾讯官方 CDN 地址，未经任何第三方修改。

**可以从新版微信降级到 6.3.31 吗？** 可以，但必须先卸载当前版本，且卸载后未备份的本地聊天记录将无法恢复。
...
## WeChat 6.3.31 version information
...
| Position in history | #109 of 133 archived versions |
| Days since previous release | 12 |

## Nearby versions

- Newer: [Download WeChat 6.3.32 APK](../6.3.32/) (2016-12-15)
- Older: [Download WeChat 6.3.30 APK](../6.3.30/) (2016-11-09)

## About WeChat 6.3.31

WeChat 6.3.31 is the Android client Tencent released on 2016-11-21. It is #109 of the 133 versions archived here.
It arrived 12 days after WeChat 6.3.30 (2016-11-09).
...
## How to install WeChat 6.3.31 APK

1. Download `weixin6331android940.apk` from the table above.
...
4. Uninstalling clears local chat history. Back it up inside WeChat before downgrading to 6.3.31.

## FAQ

**When was WeChat 6.3.31 released?** 2016-11-21.

**Is this WeChat 6.3.31 APK official?** Yes. Every link above resolves to Tencent's own CDN and the APK is unmodified.

**Can I downgrade from a newer WeChat to 6.3.31?** Yes, but you must uninstall the current version first, and any local chat history that was not backed up will be lost.

---

[← 返回全部 133 个版本 / All 133 WeChat Android versions](../)　|　[在线浏览 / View online](https://wfxu.github.io/wechat-android-apk-versions/6.3.31/)
