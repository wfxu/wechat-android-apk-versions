...
| 官方下载数 | 1 |
| 版本序号 | 133 个历史版本中的第 13 新 |
| 距上一版本 | 20 天 |

## 相邻版本

- 更新版本：[微信 8.0.65 安卓版下载](../8.0.65/)（2025-11-07）
- 更早版本：[微信 8.0.63 安卓版下载](../8.0.63/)（2025-09-09）

## 关于微信 8.0.64

微信 8.0.64 是腾讯于 2025-09-29 推出的 Android 客户端版本，在本仓库收录的 133 个历史版本中排在第 13 位。
它与前一版本微信 8.0.63（2025-09-09）相隔 20 天。
需要该版本的用户通常是为了适配旧机型、回退新版改动，或用于兼容性测试。各版本的功能更新说明请以 [微信官方更新日志](https://weixin.qq.com/updates) 为准。

## 安装说明

1. 点击上表中的链接下载 `weixin8064android2940_0x28004033_arm64_1.apk`。
2. 在系统设置中允许「安装未知来源应用」。
3. 若设备已安装更高版本的微信，需先卸载再安装微信 8.0.64；Android 不允许降级覆盖安装。
4. 卸载会清除本地聊天记录，降级前请先在微信内完成聊天记录备份。

## 常见问题

**微信 8.0.64 是什么时候发布的？** 2025-09-29。

**微信 8.0.64 的安装包能直接从官网下载吗？** 可以，上表的地址即为腾讯官方 CDN 地址，未经任何第三方修改。

**可以从新版微信降级到 8.0.64 吗？** 可以，但必须先卸载当前版本，且卸载后未备份的本地聊天记录将无法恢复。
...
## WeChat 8.0.64 version information
...
| Position in history | #13 of 133 archived versions |
| Days since previous release | 20 |

## Nearby versions

- Newer: [Download WeChat 8.0.65 APK](../8.0.65/) (2025-11-07)
- Older: [Download WeChat 8.0.63 APK](../8.0.63/) (2025-09-09)

## About WeChat 8.0.64

WeChat 8.0.64 is the Android client Tencent released on 2025-09-29. It is #13 of the 133 versions archived here.
It arrived 20 days after WeChat 8.0.63 (2025-09-09).
...
## How to install WeChat 8.0.64 APK

1. Download `weixin8064android2940_0x28004033_arm64_1.apk` from the table above.
...
4. Uninstalling clears local chat history. Back it up inside WeChat before downgrading to 8.0.64.

## FAQ

**When was WeChat 8.0.64 released?** 2025-09-29.

**Is this WeChat 8.0.64 APK official?** Yes. Every link above resolves to Tencent's own CDN and the APK is unmodified.

**Can I downgrade from a newer WeChat to 8.0.64?** Yes, but you must uninstall the current version first, and any local chat history that was not backed up will be lost.

---

[← 返回全部 133 个版本 / All 133 WeChat Android versions](../)　|　[在线浏览 / View online](https://wfxu.github.io/wechat-android-apk-versions/8.0.64/)
