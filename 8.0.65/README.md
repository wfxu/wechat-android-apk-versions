...
> 微信（WeChat）Android 8.0.65 于 2025-11-07 发布，本页收录该版本 1 个腾讯官方下载地址，安装包大小 243.4 MB，需要 Android 7.0 及以上（API 24），内部版本号（versionCode）为 2960，安装包架构为 arm64（64 位 ARM），距上一个版本 8.0.64 相隔 39 天。

> WeChat (Weixin) for Android 8.0.65 was released on 2025-11-07, this page lists 1 official Tencent download link, APK size 243.4 MB, requires Android 7.0 and up (API 24), versionCode 2960, built for arm64 (64-bit ARM), shipped 39 days after WeChat 8.0.64.

## 微信 8.0.65 下载地址

| # | 架构 | 大小 | versionCode | 安装包文件名 | 下载 |
| :-- | :-- | :-- | :-- | :-- | :-- |
| 1 | arm64 | 243.4 MB | 2960 | `weixin8065android2960_0x28004137_arm64.apk` | [直接下载](https://dldir1v6.qq.com/weixin/android/weixin8065android2960_0x28004137_arm64.apk) |
...
| 官方下载数 | 1 |
| 版本序号 | 133 个历史版本中的第 12 新 |
| 距上一版本 | 39 天 |

## 相邻版本

- 更新版本：[微信 8.0.66 安卓版下载](../8.0.66/)（2025-12-02）
- 更早版本：[微信 8.0.64 安卓版下载](../8.0.64/)（2025-09-29）

## 关于微信 8.0.65

微信 8.0.65 是腾讯于 2025-11-07 推出的 Android 客户端版本，在本仓库收录的 133 个历史版本中排在第 12 位。
它与前一版本微信 8.0.64（2025-09-29）相隔 39 天。
需要该版本的用户通常是为了适配旧机型、回退新版改动，或用于兼容性测试。各版本的功能更新说明请以 [微信官方更新日志](https://weixin.qq.com/updates) 为准。

## 安装说明

1. 点击上表中的链接下载 `weixin8065android2960_0x28004137_arm64.apk`。
2. 在系统设置中允许「安装未知来源应用」。
3. 若设备已安装更高版本的微信，需先卸载再安装微信 8.0.65；Android 不允许降级覆盖安装。
4. 卸载会清除本地聊天记录，降级前请先在微信内完成聊天记录备份。

## 常见问题

**微信 8.0.65 是什么时候发布的？** 2025-11-07。

**微信 8.0.65 的安装包能直接从官网下载吗？** 可以，上表的地址即为腾讯官方 CDN 地址，未经任何第三方修改。

**可以从新版微信降级到 8.0.65 吗？** 可以，但必须先卸载当前版本，且卸载后未备份的本地聊天记录将无法恢复。
...
| :-- | :-- | :-- | :-- | :-- | :-- |
| 1 | arm64 | 243.4 MB | 2960 | `weixin8065android2960_0x28004137_arm64.apk` | [Download APK](https://dldir1v6.qq.com/weixin/android/weixin8065android2960_0x28004137_arm64.apk) |
